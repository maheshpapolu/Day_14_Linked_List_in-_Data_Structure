...
namespace Linked_List
{
    ...
    internal class CustomLinkedList<T> where T : IComparable
    {
        ...
        public void AddWithAscendingOrder(T data) // Creating a method to add element by ascending order
        {
            ...
            {
                //If newnode is less than the head data then make new node add head which is pointing to old head
